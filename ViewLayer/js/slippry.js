...
(function ($) {
  ...
  defaults = {
    ...
    captionsSrc: 'p', // img, el [img takes caption from alt or title, el from title of slide element]
  ...
  $.fn.slippry = function (options) {
    ...
    updateCaption = function () {
      ...
      if (slip.settings.captions !== false) {
        if (slip.settings.captionsSrc !== 'p') {
          caption = slip.vars.active.attr('title');
        } else {
            caption = $('p', slip.vars.active).attr('title') !== undefined ? $('p', slip.vars.active).attr('title') : $('p', slip.vars.active).attr('title');
        }
